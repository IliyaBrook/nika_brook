'use client'
import { ImageBase } from '@/components/ImagePrimeNext/data'
...
import { DomHandler, IconUtils, ObjectUtils, ZIndexUtils } from 'primereact/utils'
import React from 'react'

export const ImagePrimeNext = React.forwardRef((inProps, ref) => {
	// states
	...
	const onEntering = () => {
		...
		const autoZIndex = context?.autoZIndex ?? true;
		const zIndexModal = context?.zIndex?.modal ?? 1000;
		
		ZIndexUtils.set('modal', maskRef.current, autoZIndex, zIndexModal);
	};
